...
const HomeEmpleado = () => {
  ...
  // Módulos principales para empleados
  const mainModules = [
    {
      title: 'Pacientes',
      description: 'Gestiona la información de los pacientes y sus expedientes clínicos.',
      icon: PeopleAlt,
    ...
    {
      title: 'Expedientes',
      description: 'Accede y actualiza los expedientes clínicos de los pacientes.',
      icon: Assignment,
  ...
  // Módulos secundarios para empleados
  const secondaryModules = [
    {
      title: 'Servicios',
      description: 'Administra los servicios odontológicos.',
      icon: MedicalServices,
      path: '/Empleado/servicios',
    },
    {
      title: 'Tratamientos',
      description: 'Gestiona los tratamientos disponibles.',
      icon: MedicalServices,
    ...
    {
      title: 'Horarios',
      description: 'Administra los horarios de trabajo.',
      icon: Schedule,
      path: '/Empleado/horarios',
    },
    {
      title: 'Reportes',
      description: 'Genera informes y reportes.',
      icon: Assessment,
      path: '/Empleado/reportes',
    },
    {
      title: 'Reseñas',
      description: 'Gestiona las reseñas de pacientes.',
      icon: RateReview,
      path: '/Empleado/reseñas',
    },
    {
      title: 'Imágenes',
      description: 'Administra archivos e imágenes.',
      icon: CloudUpload,
      path: '/Empleado/imagenes',
    },
    {
      title: 'Configuración',
      description: 'Personaliza las configuraciones.',
      icon: Settings,
    ...
    <Container maxWidth="xl" sx={{ py: { xs: 2, md: 4 } }}>
      ...
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            {getSaludo()}, {user?.nombre || 'Empleado'}
          </Typography>
          <Typography
            variant="h5"
            sx={{
          ...
          >
            Panel de Empleado - Odontología Carol
          </Typography>
          <Typography
            variant="body1"
            sx={{
          ...
          >
            Gestiona pacientes, citas, expedientes clínicos y brinda el mejor servicio odontológico desde este panel de control.
          </Typography>
          <Button
            variant="contained"
            startIcon={<PeopleAlt />}
            onClick={() => navigate('/Empleado/pacientes')}
            sx={{
