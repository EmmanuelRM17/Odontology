...
const ImagenesForm = () => {
  ...
  const fetchServices = async () => {
    ...
    try {
      ...
      // Combinar resultados
      const allServices = [
        ...(servicesWithImagesResponse.data || []),
        ...(servicesWithoutImagesResponse.data || [])
      ];
      
      setServices(allServices);
      
      // Actualizar contadores
      setServicesWithImages(servicesWithImagesResponse.data?.length || 0);
      setServicesWithoutImages(servicesWithoutImagesResponse.data?.length || 0);
  ...
  /**
   * Carga las imágenes desde Cloudinary a través de la API
   */
