...
// Componente Footer para administradores
const FooterAdmin = () => {
  ...
  // Configuración de colores específica para administradores
  const colors = {
    ...
    cardBg: isDarkTheme ? '#263238' : '#ffffff'
  };
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              >
                © {new Date().getFullYear()} Clínica Dental Carol
              </Typography>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                ...
                <Typography
                  ...
                  sx={{
                    fontWeight: 600,
                    color: isDarkTheme ? '#E8F1FF' : '#263238'
                  }}
                >
                  {modalTitle}
                </Typography>
            ...
            >
              ...
              <Box
                ...
                sx={{
                  ...
                  color: isDarkTheme ? '#E8F1FF' : '#64748B',
                }}
